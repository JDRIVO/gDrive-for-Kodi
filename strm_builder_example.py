...
with open(strmPath, 'w+') as strm:
	# Every paramater is optional besides the filename (Google Drive File ID)
	# essential strm format is: plugin://plugin.video.gdrive/?mode=video&encfs=True&filename=7ctPNMUl4m8B4KBwY
